...
struct QuestionModel {
    ...
    let questions = [
        ...
        Question(interrogative: "ตรงวงเวียนหอสมุดมศว มีรูปปั้นของใครตั้งอยู่", answers: ["ศ.สาโรช บัวศรี ", "หม่อมหลวงปิ่น มาลากุล", "หม่อมหลวงไกรฤกษ์ เกษมสันต์", "จอมมารดาหม่อมหลวงปริก"], correctAnswerIndex: 1),
        Question(interrogative: "คณะที่เปิดสอนระดับปริญญาตรีมีทั้งหมดกี่คณะ", answers: ["12 คณะ", "10 คณะ", "13 คณะ", "11 คณะ"], correctAnswerIndex: 0),
