...
//            }
    ...
    lazy var walkAction:SKAction = {
        ...
        for i in 0...1 {
            let texture = SKTexture(imageNamed: "image\(i + 1).png")
...
//go back to the Home View Controller
    ...
    var realScore2 : Int = 0 //คะแนนที่เกิดจากการตัดให้เต็ม 10 คะแนน
...
private extension StickHeroGameScene {
    ...
    func loadlife(){
         ...
         let life = SKLabelNode(fontNamed: "Arial")
         life.name = StickHeroGameSceneChildName.life.rawValue
         life.text = "4"
         life.position = CGPoint(x: 0, y: DefinedScreenHeight / 2 - 500)
         life.fontColor = SKColor.purple
         life.fontSize = 100
         life.zPosition = StickHeroGameSceneZposition.lifeZposition.rawValue
         life.horizontalAlignmentMode = .center
    ...
    func loadHero() {
        let hero = SKSpriteNode(imageNamed: "image1")
