    ...
    @IBAction func CreateChannelbtn(_ sender: Any) {
        ...
        else
        {
            ...
            //เปลื่ยน status user
                ...
                let SettingschannelVC = self.storyboard?.instantiateViewController(withIdentifier: "settingschannel") as! SettingsChannelViewController
                
                self.navigationController?.present(SettingschannelVC, animated: true, completion: nil) //แบบนี้จะไม่มีหน้า back กลับ
                return
            })
        }
    }
